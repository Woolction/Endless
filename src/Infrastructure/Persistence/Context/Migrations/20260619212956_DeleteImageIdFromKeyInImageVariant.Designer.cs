...
namespace Persistence.Context.Migrations
{
    ...
    [Migration("20260619212956_DeleteImageIdFromKeyInImageVariant")]
    partial class DeleteImageIdFromKeyInImageVariant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.ImageVariant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Domain.Entities.ChannelMeta", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Image", "Image")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.ChannelMeta", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.User", b =>
                {
                    b.OwnsOne("Domain.Common.ObjectDatas.RefreshToken", "RefreshToken", b1 =>
                        {
            ...
            modelBuilder.Entity("Domain.Entities.UserMeta", b =>
                {
                    b.HasOne("Domain.Entities.Image", "Image")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.UserMeta", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.VideoMeta", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Image", "Image")
                        .WithOne()
                        .HasForeignKey("Domain.Entities.VideoMeta", "ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
