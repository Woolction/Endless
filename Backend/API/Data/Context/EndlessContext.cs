...
public class EndlessContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        domainOwnerBuilder
            .HasKey(o => new { o.OwnerId, o.DomainId });
        domainOwnerBuilder
            .HasIndex(o => o.DomainId);

        EntityTypeBuilder<DomainSubscription> domainSubBuilder = builder.Entity<DomainSubscription>();
        domainSubBuilder
            .HasOne(dS => dS.Subscriber)
            .WithMany(d => d.SubscripedDomains)
            .HasForeignKey(uS => uS.SubscriberId);
        domainSubBuilder
            .HasOne(dS => dS.Domain)
            .WithMany(d => d.Subscribers)
            .HasForeignKey(uS => uS.DomainId);
        domainSubBuilder
            .HasKey(dS => new { dS.SubscriberId, dS.DomainId });
        domainSubBuilder
            .HasIndex(dS => dS.DomainId);
