...
namespace Backend.API.Data.Context.Migrations
{
    ...
    [Migration("20260310150336_PreparationForRecommendationAlgorithm")]
    partial class PreparationForRecommendationAlgorithm
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Backend.API.Data.Models.Content", b =>
                {
                    ...
                    b.Property<float>("AverageWatchTime")
                        .HasColumnType("real");
            ...
            modelBuilder.Entity("Backend.API.Data.Models.Content", b =>
                {
                    ...
                    b.Navigation("ContentGenreVectors");
